...
##
##Kd3HDZOFADWE8uO1
##Nc3NCtDXTlaDjpvW7Do31UrtSXsXZ8aU6/iux47c
...
##P8HPCZWEGmaZ7/K1
##L8/UAdDXTlaDjpvb9TF58UT8W1SbqXVOCW0WKzFtTzJcZpQ4+UAoanxbqQDyEk6zTf0ATLsQrNRx
##Kc/BRM3KXhU=
##
##
...
$INI_FOLDER = "C:\Inventory\Челябинск\8.Инвентаризация Челябинск.xlsx"
$AD_GREP_FILE = "C:\Inventory\Челябинск\CHL_PC.csv"
...
Where-Object {$a=$_.name; $_.DistinguishedName -notlike "*OU=Servers,OU=Computers,OU=CHL,DC=rusagrotrans,DC=ru*"} |
...
$InventoryFile.Name = 'Инвентаризация Челябинск'
$InventoryFile = $WorkBook.Worksheets.Item('Инвентаризация Челябинск')
...
$a=$_.name
$b=$_.Description
if(($a -like "*CHL_DAYANOVA_II*") -or ($a -like "*CHL_PASHNINA_EA*") -or ($a -like "*W00-0642*") -or ($a -like "W00-0656") -or ($a -like"W00-0366"))
{
}
else
{
