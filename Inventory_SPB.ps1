...
##
##Kd3HDZOFADWE8uO1
##Nc3NCtDXTlaDjpvW7Do31UrtSXsXZ8aU7fiux47c
...
##P8HPCZWEGmaZ7/K1
##L8/UAdDXTlaDjpvb9TF58UT8W1Sbr3VLCWsXHjBesloTC/BoqyrB+LTHR5gftasNis4hZdcqnd8HUBM+IOASrLfIHoc=
##Kc/BRM3KXhU=
##
##
...
$INI_FOLDER = "C:\Inventory\Санкт-Петербург\6.Инвентаризация Питер.xlsx"
$AD_GREP_FILE = "C:\Inventory\Санкт-Петербург\SPB_PC.csv"


############################################
# Получаем список ПК из AD

Get-ADComputer -Filter {Name -Like "SPB_*"}  -Properties Description |
